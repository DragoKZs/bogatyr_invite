      ...
      <Container>
        <Reveal>
          <SectionTitle
            ...
            text="Форум объединяет сотрудников компании, молодых специалистов и руководителей для обмена опытом, профессионального развития и создания новых совместных проектов."
          />
        </Reveal>
