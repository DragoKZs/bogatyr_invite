          ...
          <Reveal delay={0.4}>
            <div className="flex h-full flex-col justify-center">
              <p className="text-lg leading-9 text-white/75">
                День шахтёра — один из самых значимых профессиональных праздников для коллектива ТОО «Богатырь Көмір». Это возможность встретиться в неформальной атмосфере, провести время с коллегами, принять участие в праздничной программе и почувствовать себя частью большой команды.
              </p>
