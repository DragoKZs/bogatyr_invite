    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                className="fixed inset-0 z-[999] overflow-y-auto bg-[#03060B]"
            >
                <div className="flex min-h-screen items-center justify-center px-5 py-8 md:px-8 md:py-10">
                    {/* Фон */}
                    ...
                    <motion.div
                        ...
                        className="relative z-10 mx-auto my-8 flex min-h-[100dvh] w-full max-w-3xl items-center justify-center px-5 py-10"
                    >
                        <motion.img
                            src="/images/logo.svg"
                            alt="Богатырь Көмір"
